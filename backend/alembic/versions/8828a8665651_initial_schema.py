...
Revision ID: 8828a8665651
Revises: 
Create Date: 2025-11-25 07:57:29.989672
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_config_sms_codes_phone'), 'sms_codes', ['phone'], unique=False, schema='config')
    ...
    op.create_index(op.f('ix_config_users_email'), 'users', ['email'], unique=True, schema='config')
    op.create_index(op.f('ix_config_users_last_login'), 'users', ['last_login'], unique=False, schema='config')
    op.create_index(op.f('ix_config_users_phone'), 'users', ['phone'], unique=True, schema='config')
    ...
    op.create_index(op.f('ix_geo_regions_code'), 'regions', ['code'], unique=True, schema='geo')
    op.create_index(op.f('ix_geo_regions_name'), 'regions', ['name'], unique=False, schema='geo')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['parent_id'], ['market.categories.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index(op.f('ix_market_categories_name'), 'categories', ['name'], unique=False, schema='market')
    ...
    sa.Column('delivery_zone', geoalchemy2.types.Geometry(geometry_type='POLYGON', srid=4326, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    sa.Column('image', sa.Text(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    op.create_index('idx_stores_delivery_zone', 'stores', ['delivery_zone'], unique=False, schema='market', postgresql_using='gist')
    op.create_index('idx_stores_location', 'stores', ['location'], unique=False, schema='market', postgresql_using='gist')
    op.create_index(op.f('ix_market_stores_name'), 'stores', ['name'], unique=False, schema='market')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['region_id'], ['geo.regions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='geo'
    )
    op.create_index(op.f('ix_geo_cities_name'), 'cities', ['name'], unique=False, schema='geo')
    op.create_index(op.f('ix_geo_cities_region_id'), 'cities', ['region_id'], unique=False, schema='geo')
    ...
    sa.ForeignKeyConstraint(['user_id'], ['config.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index(op.f('ix_market_orders_created_at'), 'orders', ['created_at'], unique=False, schema='market')
    op.create_index(op.f('ix_market_orders_status'), 'orders', ['status'], unique=False, schema='market')
    op.create_index(op.f('ix_market_orders_user_id'), 'orders', ['user_id'], unique=False, schema='market')
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['config.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index(op.f('ix_market_store_owners_category_id'), 'store_owners', ['category_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_store_owners_inn'), 'store_owners', ['inn'], unique=True, schema='market')
    op.create_index(op.f('ix_market_store_owners_owner_id'), 'store_owners', ['owner_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_store_owners_status'), 'store_owners', ['status'], unique=False, schema='market')
    ...
    sa.Column('image', sa.Text(), nullable=True),
    sa.Column('category_id', sa.BigInteger(), nullable=True),
    sa.Column('store_owner_id', sa.BigInteger(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['market.categories.id'], ),
    sa.ForeignKeyConstraint(['store_owner_id'], ['market.store_owners.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index('idx_products_geo_location', 'products', ['geo_location'], unique=False, schema='market', postgresql_using='gist')
    op.create_index(op.f('ix_market_products_category_id'), 'products', ['category_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_products_created_at'), 'products', ['created_at'], unique=False, schema='market')
    op.create_index(op.f('ix_market_products_name'), 'products', ['name'], unique=False, schema='market')
    op.create_index(op.f('ix_market_products_store_owner_id'), 'products', ['store_owner_id'], unique=False, schema='market')
    ...
    op.create_index(op.f('ix_market_cart_items_product_id'), 'cart_items', ['product_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_cart_items_user_id'), 'cart_items', ['user_id'], unique=False, schema='market')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['from_user_id'], ['config.users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['product_id'], ['market.products.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['to_user_id'], ['config.users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index(op.f('ix_market_messages_created_at'), 'messages', ['created_at'], unique=False, schema='market')
    op.create_index(op.f('ix_market_messages_from_user_id'), 'messages', ['from_user_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_messages_is_read'), 'messages', ['is_read'], unique=False, schema='market')
    op.create_index(op.f('ix_market_messages_product_id'), 'messages', ['product_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_messages_to_user_id'), 'messages', ['to_user_id'], unique=False, schema='market')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['order_id'], ['market.orders.id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['market.products.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    op.create_index(op.f('ix_market_order_items_order_id'), 'order_items', ['order_id'], unique=False, schema='market')
    ...
    op.create_index(op.f('ix_market_product_images_product_id'), 'product_images', ['product_id'], unique=False, schema='market')
    ...
    op.create_index(op.f('ix_market_product_questions_created_at'), 'product_questions', ['created_at'], unique=False, schema='market')
    op.create_index(op.f('ix_market_product_questions_product_id'), 'product_questions', ['product_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_product_questions_user_id'), 'product_questions', ['user_id'], unique=False, schema='market')
    ...
    sa.Column('disadvantages', sa.Text(), nullable=True),
    ...
    op.create_index(op.f('ix_market_product_reviews_created_at'), 'product_reviews', ['created_at'], unique=False, schema='market')
    op.create_index(op.f('ix_market_product_reviews_product_id'), 'product_reviews', ['product_id'], unique=False, schema='market')
    op.create_index(op.f('ix_market_product_reviews_user_id'), 'product_reviews', ['user_id'], unique=False, schema='market')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['question_id'], ['market.product_questions.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['store_id'], ['market.stores.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['config.users.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['review_id'], ['market.product_reviews.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['store_id'], ['market.stores.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['review_id'], ['market.product_reviews.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['config.users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='market'
    )
...
def downgrade() -> None:
    ...
    op.drop_table('review_votes', schema='market')
    op.drop_table('review_responses', schema='market')
    op.drop_table('question_answers', schema='market')
    op.drop_index(op.f('ix_market_product_reviews_user_id'), table_name='product_reviews', schema='market')
    op.drop_index(op.f('ix_market_product_reviews_product_id'), table_name='product_reviews', schema='market')
    op.drop_index(op.f('ix_market_product_reviews_created_at'), table_name='product_reviews', schema='market')
    op.drop_table('product_reviews', schema='market')
    op.drop_index(op.f('ix_market_product_questions_user_id'), table_name='product_questions', schema='market')
    op.drop_index(op.f('ix_market_product_questions_product_id'), table_name='product_questions', schema='market')
    op.drop_index(op.f('ix_market_product_questions_created_at'), table_name='product_questions', schema='market')
    op.drop_table('product_questions', schema='market')
    op.drop_index(op.f('ix_market_product_images_product_id'), table_name='product_images', schema='market')
    op.drop_table('product_images', schema='market')
    op.drop_index(op.f('ix_market_order_items_order_id'), table_name='order_items', schema='market')
    op.drop_table('order_items', schema='market')
    op.drop_index(op.f('ix_market_messages_to_user_id'), table_name='messages', schema='market')
    op.drop_index(op.f('ix_market_messages_product_id'), table_name='messages', schema='market')
    op.drop_index(op.f('ix_market_messages_is_read'), table_name='messages', schema='market')
    op.drop_index(op.f('ix_market_messages_from_user_id'), table_name='messages', schema='market')
    op.drop_index(op.f('ix_market_messages_created_at'), table_name='messages', schema='market')
    op.drop_table('messages', schema='market')
    op.drop_index(op.f('ix_market_cart_items_user_id'), table_name='cart_items', schema='market')
    op.drop_index(op.f('ix_market_cart_items_product_id'), table_name='cart_items', schema='market')
    op.drop_table('cart_items', schema='market')
    op.drop_index(op.f('ix_market_products_store_owner_id'), table_name='products', schema='market')
    op.drop_index(op.f('ix_market_products_name'), table_name='products', schema='market')
    op.drop_index(op.f('ix_market_products_created_at'), table_name='products', schema='market')
    op.drop_index(op.f('ix_market_products_category_id'), table_name='products', schema='market')
    op.drop_index('idx_products_geo_location', table_name='products', schema='market', postgresql_using='gist')
    op.drop_table('products', schema='market')
    op.drop_index(op.f('ix_market_store_owners_status'), table_name='store_owners', schema='market')
    op.drop_index(op.f('ix_market_store_owners_owner_id'), table_name='store_owners', schema='market')
    op.drop_index(op.f('ix_market_store_owners_inn'), table_name='store_owners', schema='market')
    op.drop_index(op.f('ix_market_store_owners_category_id'), table_name='store_owners', schema='market')
    op.drop_table('store_owners', schema='market')
    op.drop_index(op.f('ix_market_orders_user_id'), table_name='orders', schema='market')
    op.drop_index(op.f('ix_market_orders_status'), table_name='orders', schema='market')
    op.drop_index(op.f('ix_market_orders_created_at'), table_name='orders', schema='market')
    op.drop_table('orders', schema='market')
    op.drop_index(op.f('ix_geo_cities_region_id'), table_name='cities', schema='geo')
    op.drop_index(op.f('ix_geo_cities_name'), table_name='cities', schema='geo')
    op.drop_table('cities', schema='geo')
    op.drop_index(op.f('ix_market_stores_name'), table_name='stores', schema='market')
    op.drop_index('idx_stores_location', table_name='stores', schema='market', postgresql_using='gist')
    op.drop_index('idx_stores_delivery_zone', table_name='stores', schema='market', postgresql_using='gist')
    op.drop_table('stores', schema='market')
    op.drop_index(op.f('ix_market_categories_name'), table_name='categories', schema='market')
    op.drop_table('categories', schema='market')
    op.drop_index(op.f('ix_geo_regions_name'), table_name='regions', schema='geo')
    op.drop_index(op.f('ix_geo_regions_code'), table_name='regions', schema='geo')
    op.drop_table('regions', schema='geo')
    op.drop_index(op.f('ix_config_users_phone'), table_name='users', schema='config')
    op.drop_index(op.f('ix_config_users_last_login'), table_name='users', schema='config')
    op.drop_index(op.f('ix_config_users_email'), table_name='users', schema='config')
    op.drop_table('users', schema='config')
    op.drop_index(op.f('ix_config_sms_codes_phone'), table_name='sms_codes', schema='config')
    op.drop_table('sms_codes', schema='config')
    # ### end Alembic commands ###
