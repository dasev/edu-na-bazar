...
# Категории
CATEGORIES = [
    {"name": "Фрукты", "slug": "fruits", "icon": "🍎", "sort_order": 1},
    {"name": "Овощи", "slug": "vegetables", "icon": "🥕", "sort_order": 2},
    {"name": "Молочные продукты", "slug": "dairy", "icon": "🥛", "sort_order": 3},
    {"name": "Мясо и птица", "slug": "meat", "icon": "🍖", "sort_order": 4},
    {"name": "Хлеб и выпечка", "slug": "bakery", "icon": "🍞", "sort_order": 5},
    {"name": "Напитки", "slug": "drinks", "icon": "🥤", "sort_order": 6},
    {"name": "Сладости", "slug": "sweets", "icon": "🍬", "sort_order": 7},
    {"name": "Бакалея", "slug": "grocery", "icon": "🌾", "sort_order": 8},
]
